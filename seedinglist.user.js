...
// @description    How to: 0) sing-in rutracker.org 1) go to same rutracker's forum(link equal "http://rutracker.org/forum/viewforum.php?f=*"); 2) In top window click "Generate SeedingList";3) wait some time 4) use new seeding list
// @include        http://rutracker.org/forum/viewforum.php?f=*
// @match          http://rutracker.org/forum/viewforum.php?f=*
// ==/UserScript==
function w(){if(typeof unsafeWindow.jQuery=='undefined'){window.setTimeout(w,100);}else{$=unsafeWindow.jQuery;code();}}w();
function code(){
...
/**/$("body").append("<div id='xmlarea' style='display:none;z-index:1001;position:fixed;top:10px;left:10px;'><textarea id='xml' cols='80' rows='16'></textarea><input type='button' value='Close'/></div><div id='openmenu' style='display:none;width:400px;height:100px;paddig:25px;background-color:#F3F3F3;z-index:1000;position:fixed;top:35px;left:55px;border:3px dashed;'><input type='button' id='gen_xml' value='Generate XML' style='display:none;'/><br /><code>Seeds&nbsp;:</code><span style='font: arial, 6pt, bold'><input type='checkbox' id='filter_seeds_0' checked/>[0]<input type='checkbox' id='filter_seeds_12' checked/>[1-2]<input type='checkbox' id='filter_seeds_34' checked/>[3-4]<input type='checkbox' id='filter_seeds_5' checked/>[5]<input type='checkbox' id='filter_seeds_610' checked/>[6-10]<input type='checkbox' id='filter_seeds_11' checked/>[11+]</span><br /><code>Leechs:</code><span style='font: arial, 6pt, bold'><input type='checkbox' id='filter_leechers_0' checked/>[0]<input type='checkbox' id='filter_leechers_12' checked/>[1-2]<input type='checkbox' id='filter_leechers_34' checked/>[3-4]<input type='checkbox' id='filter_leechers_5' checked/>[5]<input type='checkbox' id='filter_leechers_610' checked/>[6-10]<input type='checkbox' id='filter_leechers_11' checked/>[11+]</span><br /><input type='button' id='filter_hideall' value='Hide all'/><input type='button' id='filter_showall' value='Show all'/><input type='button' id='filter_apply' value='Apply'/></div>");
...
function lng(){$("#torrent_table thead th strong").eq(0).text($("#torrent_table tbody tr:visible").length);}
...
/*$("#filter_seeds_0").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,0,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_seeds_12").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,12,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_seeds_34").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,34,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_seeds_5").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,5,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_seeds_610").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,610,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_seeds_11").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(1,11,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_0").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,0,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_12").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,12,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_34").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,34,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_5").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,5,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_610").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,610,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})
$("#filter_leechers_11").change(function(){var checked = $(this).attr('checked');var sel="";if (checked){sel="#torrent_table tbody tr:hidden"}else{sel="#torrent_table tbody tr:visible"}$(sel).each(function(){if (filter(2,11,$(this))){if (checked) {$(this).show();}else{$(this).hide();}lng();}})})/**/
$("#filter_hideall").click(function(){$("#openmenu :checkbox").removeAttr("checked");});
$("#filter_showall").click(function(){$("#openmenu :checkbox").attr("checked","true");});
function filter2(me,ar){
var seed = parseInt($("td",me).eq(1).text());
var leech = parseInt($("td",me).eq(2).text());
var r = true;
if ((seed==0)&&(ar[0])){r=false;}
if ((seed>=1)&&(seed<=2)&&(ar[1])){r=false;}
if ((seed>=3)&&(seed<=4)&&(ar[2])){r=false;}
if ((seed==5)&&(ar[3])){r=false;}
if ((seed>=6)&&(seed<=10)&&(ar[4])){r=false;}
if ((seed>=11)&&(ar[5])){r=false;}
if ((leech==0)&&(ar[6])){r=false;}
if ((leech>=1)&&(leech<=2)&&(ar[7])){r=false;}
if ((leech>=3)&&(leech<=4)&&(ar[8])){r=false;}
if ((leech==5)&&(ar[9])){r=false;}
if ((leech>=6)&&(leech<=10)&&(ar[10])){r=false;}
if ((leech>=11)&&(ar[11])){r=false;}
return r;
}
$("#filter_apply").click(function(){
var ar=[];
$("#openmenu :checkbox").each(function(){ar.push(!($(this).attr("checked")==true))});
$("#torrent_table tbody tr").each(function(){if (filter2($(this),ar)){$(this).show();}else{$(this).hide();}});
$("#torrent_table thead th strong").eq(0).text($("#torrent_table tbody tr:visible").length);
});
